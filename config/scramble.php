...
return [
    ...
    'info' => [
        ...
        'description' => 'PetCare+ learning API. Login via POST /api/v1/auth/login, copy data.token, Authorize Bearer, then call cart/orders. Seed user: khach@petcare.test / password',
    ],

    'ui' => [
        'title' => 'PetCare Learning API',
    ],
